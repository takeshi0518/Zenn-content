...
```
Warning: Text content did not match. Server: "01:13:51" Client: "01:13:50"
```

サーバー側で生成されたテキスト(`01:13:51`)と、クライアント側で生成されたテキスト(`01:13:50`)が、わずか 1 秒ズレているだけでエラーになっています。  
このわすかな時刻のズレが、ハイドレーションエラーの原因でした。
